...
`Meowww` is a C library that provides useful functions and data structures to make development easier. The best part? It is a header-only library, you can simply copy the library and it will just work!
...
2. If you do not want to deal with a directory in your project, you can use `dist/meowww.h` which is a compiled version of all library headers.
	+ This file is standalone and does not depend on anything other than the standard C library.
...
+ `mw_` prefix is used to the library defintions, macros and functions. Use these!
+ `_mw_` prefix is for internal library defintions. It is recommended to not use these.
